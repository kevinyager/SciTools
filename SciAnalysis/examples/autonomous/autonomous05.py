...
results = np.load('../../gpcam/decision-received.npy', allow_pickle=True); print_results(results)
results = np.load('../../gpcam/decision-sent.npy', allow_pickle=True); print_results(results)
'''
